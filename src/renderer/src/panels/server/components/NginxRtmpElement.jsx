...
const NginxRtmpElement = () => {
  ...
  return (
    <Box>
      <Stack gap={2}>
        <TextField
          label={t('server.nginxRtmp.nameBox.label')}
          ...
          helperText={errorMessages.name || t('server.nginxRtmp.nameBox.hint')}
          slotProps={{
            input: {
        ...
        >
          <TextField
            fullWidth
            label={t('server.nginxRtmp.urlBox.label')}
            ...
            helperText={errorMessages.statsUrl || t('server.nginxRtmp.urlBox.hint')}
            slotProps={{
              input: {
          ...
          <TextField
            fullWidth
            label={t('server.nginxRtmp.publisherBox.label')}
            placeholder={t('server.nginxRtmp.publisherBox.placeholder')}
            ...
            helperText={errorMessages.publisher || t('server.nginxRtmp.publisherBox.hint')}
            slotProps={{
              input: {
...
export default NginxRtmpElement;
