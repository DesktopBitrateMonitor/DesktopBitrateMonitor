  ...
  const overlayConfig = new Store({
    ...
    defaults: {
      ...
      overlay: {
        ...
        html: '<link rel=\"stylesheet\"\r\n    href=\"https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200\" />\r\n\r\n<div id=\"root\">\r\n    <div class=\"bitrate-container\">\r\n        <span id=\"bitrate-icon\" class=\"material-symbols-outlined\"\r\n          >signal_cellular_0_bar</span>\r\n        <div class=\"bitrate-txt\">Loading...</div>\r\n    </div>\r\n    <div class=\"speed-container\">\r\n        <span id=\"speed-icon\" class=\"material-symbols-outlined\">speed</span>\r\n        <div class=\"speed-txt\">Loading...</div>\r\n    </div>\r\n    <div class=\"uptime-container\">\r\n        <span id=\"uptime-icon\" class=\"material-symbols-outlined\">timer</span>\r\n        <div class=\"uptime-txt\">Loading...</div>\r\n    </div>\r\n    <div class=\"total-uptime-container\">\r\n        <span id=\"totla-uptime-icon\" class=\"material-symbols-outlined\">all_inclusive</span>\r\n        <div class=\"total-uptime-txt\">Loading...</div>\r\n    </div>\r\n</div>',
        css: ':root {\r\n  --color: rgb(88, 95, 145);\r\n}\r\n\r\n* {\r\n  font-family: Verdana, Geneva, Tahoma, sans-serif;\r\n}\r\n\r\n#root {\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: .5rem;\r\n  background: rgba(0, 0, 0, 0.397);\r\n  padding: 8px;\r\n  border-radius: 8px;\r\n  max-width: 200px;\r\n}\r\n\r\n\r\n.bitrate-container,\r\n.speed-container,\r\n.uptime-container,\r\n.total-uptime-container {\r\n  display: flex;\r\n  align-items: center;\r\n  gap: 0.5rem;\r\n}\r\n\r\n.material-symbols-outlined {\r\n  font-size: 8px;\r\n  color: var(--color);\r\n}\r\n\r\n.bitrate-txt,\r\n.speed-txt,\r\n.uptime-txt,\r\n.total-uptime-txt {\r\n  font-size: 24px;\r\n  color: var(--color);\r\n}',
        js: '\r\n// PROPS object returns the bitrate, speed, uptime from the current active feed, otherwise 0\r\nconst bitrate = PROPS.bitrate\r\nconst speed = PROPS.speed.toFixed(2)\r\nconst uptime = PROPS.uptime\r\n\r\n$(".bitrate-txt").text(`${bitrate} kb/s`);\r\n\r\nconst updateImageOnBitrate = () => {\r\n  let imgTxt;\r\n  if (bitrate >= 4000) {\r\n    imgTxt = "signal_cellular_alt";\r\n  } else if (bitrate >= 1200) {\r\n    imgTxt = "signal_cellular_alt_2_bar";\r\n  } else if (bitrate >= 600) {\r\n    imgTxt = "signal_cellular_alt_1_bar";\r\n  } else {\r\n    imgTxt = "signal_cellular_connected_no_internet_0_bar";\r\n  }\r\n  $("#bitrate-icon").text(imgTxt);\r\n};\r\n\r\nupdateImageOnBitrate();\r\n\r\n$(\'.speed-txt\').text(`${speed} ms`);\r\n\r\nconst stopwatch = (time) => {\r\n  const h = Math.floor(time / 3600);\r\n  const m = Math.floor((time % 3600) / 60);\r\n  const s = Math.floor(time % 60);\r\n  const two = (n) => n.toString().padStart(2, \'0\');\r\n  return h > 0 ? `${two(h)}:${two(m)}:${two(s)}` : `${two(m)}:${two(s)}`;\r\n}\r\n\r\n$(\'.uptime-txt\').text(stopwatch(uptime));\r\n\r\nlet totalUptimeSeconds = 0;\r\nconst totalUptime = () => {\r\n  totalUptimeSeconds += uptime;\r\n  return stopwatch(totalUptimeSeconds);\r\n}\r\n\r\n$(\'.total-uptime-txt\').text(stopwatch(uptime));\r\n'
      }
    }
  });
