...
#### The view of the full dashboard and short descriptions of the components
  ...
  <ol>
    ...
    <li>Full Feed-Chart</li>
      <ul>
        <li>Displays the live bitrate in a line chart from the main server instance (top instance in the list)</li>
      </ul>
      <ul>
    ...
    <li>Connection status:</li>
      <ul>
        ...
        <li>Orange: Not all connected</li>
...
<details>
  ...
  <div >
    <ul>
      <li>
        Enable or disable multiple platforms
      </li>
      <li>
        When en/disabling any platform, the app automatically reconnect to all enabled ones
      </li>
    </ul>
  </div>
...
![image](readme-assets/platform/chat-commands.png)
  ...
  <ol>
    ...
    <li>Cooldown's</li>
    <ul>
      <li>All: Cooldown is for everyone (Broadcaster and Admins included)</li>
      <li>Moderator: Cooldown is for Moderators and lower permission users</li>
      <li>User: Cooldown only for the role "All"</li>
    </ul>
    <li>Aliases</li>
    <ul>
      <li>
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <h6>
            For Youtube only on planed stream chats
          </h6>
        </td>
        <td>!start</td>
        <td>Broadcaster</td>
      ...
      <tr>
        ...
        <td>Enables the switcher service</td>
      ...
      <tr>
        ...
        <td>Disable the switcher service</td>
...
- Chatbot account is a option (only for Twitch or Kick)
- Youtube does not support a alternate chatbot to post messages
...
### Youtube information's

- Youtube you have to setup the broadcasters name into the textfield. After login a window opens to login the account from the Youtube user you typed in to the textfield

![image](readme-assets/platform/youtube-channel-name.png)

- This step is really important, without the login the chatbot doesn't works

![image](readme-assets/platform/youtube-login.png)

- The best way to make sure the app listens to a chat from a livestream, plane the stream
  - On not planed Youtube livestream's i could be buggy to listen for the chat messages
...
- The Bitrate Monitor listens for all active server instances
- The top instance ist the "Primary Instance"
  - Stats displayed in the live chart
  - Stats logged in the sessions logs
- To set a instance to the primary instance, drag & drop the instance to the top of the list
  - After reordering the stats fetching automatically restarts
...
![image](readme-assets/server/server-settings.png)
  ...
  <ol>
    ...
    <ul>
      <li>
        New instance are disabled
      </li>
      <li>
        Server Type Select
      </li>
      <li>
        Server Name: The name are used for logging and is displayed in the connection states
      </li>
      <li>
        Stats URL: The URL to listen for the feed stats
      </li>
      <li>
        Publisher
      </li>
    ...
    <ul>
      <li>
        Edit any setting, disable/enable the instance or remove it
      </li>
    </ul>
  </ol>
...
- Switch from Offline/Starting to live without any active feed: Any of the instances is above the "to live" threshold
- Switch from live to low: All of the active feeds must be below the "to low" threshold
- Switch from to live from low: The "Primary Instance" above the "to live" threshold to recover
  - If the "Primary Instance" stays below the threshold and all other instance above the threshold, the switcher will <b> NOT </b> recover to live
...
![image](readme-assets/switcher/scene-settings.png)
  ...
  <ol>
    ...
    <ul>
      <li>
        The scene collection in the broadcasting software with the scenes for the app. If the collection name empty, the current scene collection are used. If a collection is specified, the switcher try to change to the specified collection on the start stream command event
      </li>
    </ul>
    <li>
      Live Scene
